 ...
 <meta name="application-name" content="https://tspectreenterprises.com/" />
   <meta name="msapplication-square70x70logo" content="live/small.jpg" />
    ...
    <meta name="msapplication-notification" content="frequency=30;polling-uri=http://notifications.buildmypinnedsite.com/?feed=https://tspectreenterprises.com/feed&amp;id=1;polling-uri2=http://notifications.buildmypinnedsite.com/?feed=https://tspectreenterprises.com/feed&amp;id=2;polling-uri3=http://notifications.buildmypinnedsite.com/?feed=https://tspectreenterprises.com/feed&amp;id=3;polling-uri4=http://notifications.buildmypinnedsite.com/?feed=https://tspectreenterprises.com/feed&amp;id=4;polling-uri5=http://notifications.buildmypinnedsite.com/?feed=https://tspectreenterprises.com/feed&amp;id=5; cycle=1"/>
		<!-- favicon -->
		<link rel="icon" href="timg/favicon.ico" type="image/x-icon" />
		<link rel="shortcut icon" href="timg/favicon.ico" type="image/x-icon" />
...
<div class="nav-wrapper">
 ...
 <li><a class="black-text" href="#"/>Terms + Conditions</a></li>       
     <li><a class="black-text" href="privacy.php"/>Privacy Policy</a></li>  
	 <li><a class="black-text" href="the-fine-print.php"/>Store Policy</a></li>  
	    <li><a class="black-text" href="consumer-terms.php"/>Consumer Policy</a></li> 
		<li><a class="black-text bold" href="cookies.php"/>Cookie Policy</a></li> 
...
<h4>Cookies from third parties</h4>
Third parties (external to tSpectre Enterprises) may also store cookies on your computer during your visit to Philips websites. These indirect cookies are similar to direct cookies but come from a different domain (non-tSpectre Enterprises) to the one you are visiting.
    Further information about tSpectre Enterprises's use of cookies
    Do Not Track Signals

    tSpectre Enterprises takes privacy and security very seriously, and strives to put our website users first in all aspects of our business. tSpectre Enterprises utilises cookies to help you to get the most out of the tSpectre Enterprises websites.
     
    Please be aware that tSpectre Enterprises currently does not make use of a technical solution that would enable us to respond to your browser's 'Do Not Track' signals. In order to manage your cookie preferences, however, you may alter the cookie settings in your browser settings at any time. You may accept all, or certain, cookies. If you do disable our cookies in your browser settings, you may find that certain sections of our website(s) will not work. For example, you may have difficulties logging in or making online purchases.
    ...
    On the pages published across the digital titles produced by tSpectre Enterprises, Flash cookies may also be used. Flash cookies may be removed by managing your Flash Player settings. Depending on the version of Internet Explorer (or other browser) and media player you use, you may be able to manage Flash cookies with your browser. You may manage Flash Cookies by visiting Adobe's website. Please be aware that restricting the use of Flash Cookies may affect the features available to you.
    
	Further information about the type of cookies used on tSpectre Enterprises sites  
    Cookies that ensure that the website functions properly
    
    These cookies are necessary to make it possible to surf the tSpectre Enterprises website(s) and use the website's functions, such as accessing protected areas of the website. Without these cookies, such functions, including shopping baskets and electronic payment, are not possible.
